...
# PURPOSE: rename SOL-AMM files used in NUCLEATION - NSRI PROJECT
...
ls *em.* > list1.txt    #for system_ammwat_em.gro
ls *em.* > list2.txt
...
vim -c ":%s/system_ammwat_em./system_emm1_SOL_AMM./g" -c ":wq" list2.txt
...
vim -c ":%s/system_ammwat_em${kip}/system_emm${kap}_SOL_AMM/g" -c ":wq" list2.txt
...
ls *_nvt.* > list1.txt    #for system_ammwat_em.gro
ls *_nvt.* > list2.txt
...
vim -c ":%s/system_ammwat_nvt/system_nvt1_SOL_AMM/g" -c ":wq" list2.txt
...
vim -c ":%s/system_ammwat_md${kip}/system_mdd${kip}_SOL_AMM/g" -c ":wq" list2.txt
...
ls *_md${kip}_* > list1.txt       #the only difference with the previous is underscore after ${kip}
...
vim -c ":%s/system_ammwat_md1-${kip}/system_mdd1-${kip}_SOL_AMM/g" -c ":wq" list2.txt
